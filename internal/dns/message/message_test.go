...
func TestQuery_Identification(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			data:     []byte{0x00, 0xFF, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x03, 0x63, 0x6f, 0x6d, 0x00},
			expected: 255,
		},
	}
...
func TestQuery_OpCode(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			data:     []byte{0x00, 0xFF, 0x08, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x03, 0x63, 0x6f, 0x6d, 0x00},
			expected: 1,
		},
		{
			name:     "extracts max opcode from message",
			data:     []byte{0x00, 0x00, 0x78, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x03, 0x63, 0x6f, 0x6d, 0x00},
			expected: 15,
		},
	}
...
func TestQuery_IsRecursionDesired(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			data:     []byte{0x00, 0x00, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x03, 0x63, 0x6f, 0x6d, 0x00},
			expected: true,
		},
		{
			name:     "returns false otherwise",
			data:     []byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x03, 0x63, 0x6f, 0x6d, 0x00},
			expected: false,
		},
	}
